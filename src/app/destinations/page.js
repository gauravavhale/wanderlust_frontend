...
const Destination = () => {
  ...
  return (
    <div className='h-full w-full mt-17'>
          ...
          <div className='relative flex flex-wrap gap-5 justify-center mt-10 md:max-w-[80vw]'>
            {Destinantion.map((destiny) => (
              <div key={destiny.src} className='relative'>
                <Link href={`/packages/${destiny.loc}`}>
                <Image src={destiny.src}  height={100} width={100} className='w-[150px] h-[150px] md:w-[300px] md:h-[300px] object-cover rounded-lg' alt={destiny.loc}/>
      ...
      <div className="flex flex-col items-center mt-10 bg-[#fae1d7] p-6 px-8 shadow mb-10">
